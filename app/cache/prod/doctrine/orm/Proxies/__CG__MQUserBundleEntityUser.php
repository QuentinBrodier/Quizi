...
namespace Proxies\__CG__\MQ\UserBundle\Entity;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class User extends \MQ\UserBundle\Entity\User implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'MQ\\UserBundle\\Entity\\User' . "\0" . 'id', '' . "\0" . 'MQ\\UserBundle\\Entity\\User' . "\0" . 'username', '' . "\0" . 'MQ\\UserBundle\\Entity\\User' . "\0" . 'mail', '' . "\0" . 'MQ\\UserBundle\\Entity\\User' . "\0" . 'password', '' . "\0" . 'MQ\\UserBundle\\Entity\\User' . "\0" . 'salt', '' . "\0" . 'MQ\\UserBundle\\Entity\\User' . "\0" . 'roles');
        }
